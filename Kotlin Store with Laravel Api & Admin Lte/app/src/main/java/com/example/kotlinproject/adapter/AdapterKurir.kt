...
class AdapterKurir(var data: ArrayList<Costs>, var kurir: String, var listener: Listeners) : RecyclerView.Adapter<AdapterKurir.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.tvHarga.text = com.example.kotlinproject.helper.Helper().changeRupiah(cost.value)
        holder.tvBerat.text = "1 kg x " + com.example.kotlinproject.helper.Helper().changeRupiah(cost.value)
